...
bool zMatEig(zMat m, zCVec eigval, zCMat eigbase, int iter)
{
...
bool zMatSymEigBisec(zMat m, zVec eigval, zMat eigbase)
{
  double emin, emax;
  int nmin, nmax;
...
bool zMatSymEigJacobi(zMat m, zVec eigval, zMat eigbase)
{
  int i, j, n = 0;
  double shift;
  bool is_complete;
