...
/* create an ODE solver based on classical Runge-Kutta method. */
zODE* zODECreateRK4(zODE *ode, int dim, int dummy, zVec (* f)(double,zVec,void*,zVec))
{
  _zODE_RK4 *ws;
...
zVec zODEUpdateRK4(zODE *ode, double t, zVec x, double dt, void *util)
{
  _zODE_RK4 *ws;
  double dt1, dt2, dt3;
