...
/* create an ODE solver based on Heun method. */
zODE* zODECreateHeun(zODE *ode, int dim, int dummy, zVec (* f)(double,zVec,void*,zVec))
{
  _zODE_Heun *ws;
...
zVec zODEUpdateHeun(zODE *ode, double t, zVec x, double dt, void *util)
{
  _zODE_Heun *ws;
