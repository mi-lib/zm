 ...
 */
__EXPORT int zOptSolvePSO(double (* f)(zVec,void*), void *util, zVec min, zVec max, int iter, double tol, int num, double c1, double c2, double vel_rate, zVec ans, double *eval);
 ...
 */
__EXPORT int zOptSolvePSODefault(double (* f)(zVec,void*), void *util, zVec min, zVec max, int iter, double tol, zVec ans, double *eval);
