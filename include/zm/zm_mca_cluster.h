 ...
 *//* ******************************************************* */
typedef struct{
  zVecAddrList vl; /*!< \brief list of vectors */
...
typedef struct{
  ...
  zVec (* _mean_fp)(zVecAddrList*,void*,zVec); /* mean function */
  zVec (* _error_fp)(zVec,zVec,void*,zVec); /* error function */
  zVec _err; /* error vector */

  zVec (* _mean_l_fp)(zVecAddrList*,double[],double,void*,zVec); /* loaded mean function */
...
__EXPORT zClusterMethod *zClusterMethodCreate(zClusterMethod *met, int meansize, zVec (* mean_fp)(zVecAddrList*,void*,zVec), int errorsize, zVec (* error_fp)(zVec,zVec,void*,zVec));
__EXPORT zClusterMethod *zClusterMethodLoadedCreate(zClusterMethod *met, zVec (* mean_l_fp)(zVecAddrList*,double[],double,void*,zVec));
...
__EXPORT zMCluster *zMClusterInit(zMCluster *mc, int meansize, zVec (* mean_fp)(zVecAddrList*,void*,zVec), int errorsize, zVec (* error_fp)(zVec,zVec,void*,zVec));
...
__EXPORT int zMClusterKMeans(zMCluster *mc, zVecAddrList *points, int k, void *mean_util, void *err_util);

/*! \brief clustering of vectors by X-means */
__EXPORT int zMClusterXMeans(zMCluster *mc, zVecAddrList *points, void *mean_util, void *err_util);

/*! \brief clustering of vectors by X-means based on BIC */
__EXPORT int zMClusterXMeansBIC(zMCluster *mc, zVecAddrList *points, void *mean_util, void *err_util);
